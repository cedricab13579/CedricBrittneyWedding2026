...
export default function WeddingWebsite() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-wedding-blush to-wedding-peach">
        ...
        <div className="max-w-6xl mx-auto px-4 py-0">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link href="/menu" className="text-wedding-teal hover:text-wedding-forest font-medium transition-colors">
                Menu
              </Link>
              ...
              <Link
                href="/registry"
                className="text-wedding-teal hover:text-wedding-forest font-medium transition-colors"
              >
                Registry
              </Link>
          ...
          <div className="text-center my-8">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-6 max-w-xl mx-auto mb-6 border border-white/20">
              ...
              <div className="flex items-center justify-center gap-4">
                <span className="text-xl text-white">289 Hollyfield Lane</span>
              </div>
              <div className="flex items-center justify-center gap-4">
                <span className="text-xl text-white">Manquin, VA 2310</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We've known each other for 17 years, stretching waaaaay back to third grade, where we were fast
                  friends. It took Cedric only 8-ish more years to muster the courage, asking for a first date in
                  December 2016, where our love story begins. From there we've been inseperable, through long distance
                  in undergrad to living together as Brittney completes her doctorate.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-serif text-wedding-forest mb-3">The Proposal</h3>
                <p className="text-gray-700 leading-relaxed">
                  In February 2025 after 8 years of dating, Cedric and Brittney were finally ready to take the next step
                  in their lives togehter. After an exciting day of falconry on a gorgous winter day, Cedric and
                  Brittney came home to a warm home-cooked meal where through happy tears, she said yes!
                </p>
              </div>
            </div>
          </div>
      ...
      {/* RSVP Section */}
      <section id="rsvp" className="py-16 px-4 bg-gradient-to-b from-wedding-blush to-wedding-peach">
            ...
            <Card className="border-wedding-sage bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">• Virginia Crossings Hotel</p>
                  <p className="text-gray-600">• Hamptom Inn</p>
                  <p className="text-gray-600">• Holiday Inn Express</p>
                  <p className="text-gray-600">• Marriot Downtown Richmond</p>
                </div>
              </CardContent>
            </Card>
          </div>
